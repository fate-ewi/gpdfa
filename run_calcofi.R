...
x = group_by(df_all, scientific_name, year, quarter) %>%
  ...
  dplyr::filter(year >= 2000, quarter==2)
...
m1 = fit_dfa(y = x, data_shape = "long", iter = 3000, chains = 1, num_trends = 1)
m2 = fit_dfa(y = x, data_shape = "long", iter = 3000, chains = 1, num_trends = 2)

m3 = fit_dfa(y = x, data_shape = "long", iter = 3000, chains = 1, trend_model="gp", n_knots = 9, num_trends = 1)
m4 = fit_dfa(y = x, data_shape = "long", iter = 3000, chains = 1, trend_model="gp", n_knots = 9, num_trends = 2)

m5 = fit_dfa(y = x, data_shape = "long", iter = 3000, chains = 1, trend_model="spline", n_knots = 9, num_trends = 1)
m6 = fit_dfa(y = x, data_shape = "long", iter = 3000, chains = 1, trend_model="spline", n_knots = 9, num_trends = 2)
